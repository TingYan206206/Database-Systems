...
<!--					<div class="title_name">--><?php //print 'Logged in by: '.$user_name; ?><!--</div>-->
					<div class="features">
                            ...
                            <table id="myTable" style="width:200%">
                                ...
                                <?php while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ ?>
                                    ...
                                    <tr style="font-size:12px">
                                        <td><a href="<?php echo 'reservation_detail.php?reservation_id=' . $row['reservation_id']; ?>"><?php echo $row['reservation_id'] ?></a></td>
						...
						<div class="choose_reservation_to_pickup">
                            ...
                            <form action="pickup_summary.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="login_form_row">
                                    ...
                                    <input type="image" src="img/pick-up.gif" class="pickup"/>
